...
func (Person_PhoneType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_addressbook_5dad2e83acdb79bd, []int{0, 0}
}
...
func (*Person) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressbook_5dad2e83acdb79bd, []int{0}
}
...
func (*AddressBook) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressbook_5dad2e83acdb79bd, []int{1}
}
...
func init() { proto.RegisterFile("addressbook.proto", fileDescriptor_addressbook_5dad2e83acdb79bd) }

var fileDescriptor_addressbook_5dad2e83acdb79bd = []byte{
